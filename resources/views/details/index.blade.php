                ...
                <div class="details-items">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="rounded details-image-vertical black-slide">
                                        <div>
            ...
            <div class="col-12">
                <div class="cloth-review">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="overflow-auto tab-pane fade" id="nav-guide">
                            <div class="table-responsive">
                                <table class="table mb-0 table-pane">
                                    <tbody>
                                        <tr class="bg-color">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-4">
                                    <div class="customer-rating">
                                        ...
                                        <ul class="my-2 rating d-inline-block">
                                            <li>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <ul class="mb-3 rating d-inline-block">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                                        </li>
                                        <li>
                                    ...
                                    <div class="customer-review-box">
                                        ...
                                        <div class="customer-section">
                                            ...
                                            <div class="customer-details">
                                                ...
                                                <p class="font-light date-custo">- Sep 08, 2021</p>
                                            </div>
                                        </div>
...
<section class="overflow-hidden ratio_asos section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="mb-3 mb-lg-4">Customers Also Bought These</h2>
                <div class="p-0 product-wrapper product-style-2 slide-4 light-arrow bottom-space">
