...
@section('content')
    <section class="pt-0 poster-section">
        ...
        <div class="left-side-contain">
            <div class="banner-left">
                ...
                <p class="mb-0 poster-details">Lorem Ipsum is simply dummy text of the printing and typesetting
                    industry.</p>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6">
                    <div class="text-center collection-banner p-bottom p-center">
    ...
    <section class="overflow-hidden ratio_asos">
                ...
                <div class="col-xl-2 col-lg-2 col-6">
                    <div class="product-box">
                        ...
                        <div class="product-style-3 product-style-chair">
                            <div class="mb-0 product-title d-block">
                                <div class="r-price">
                                    <div class="theme-color">$5</div>
                                    <div class="main-price">
                                        <ul class="mt-0 mb-1 rating">
                                            <li>
                                ...
                                <p class="mb-0 font-light mb-sm-2">Dolores Et</p>
                    ...
                    <div class="product-box">
                        ...
                        <div class="product-style-3 product-style-chair">
                            <div class="mb-0 product-title d-block">
                                ...
                                <p class="mb-0 font-light mb-sm-2">Blanditiis Error</p>
                                <a href="product/details.html" class="font-default">
                    ...
                    <div class="product-box">
                        ...
                        <div class="product-style-3 product-style-chair">
                            <div class="mb-0 product-title d-block">
                                ...
                                <p class="mb-0 font-light mb-sm-2">Qui Ut</p>
                                <a href="product/details.html" class="font-default">
                    ...
                    <div class="product-box">
                        ...
                        <div class="product-style-3 product-style-chair">
                            <div class="mb-0 product-title d-block">
                                ...
                                <p class="mb-0 font-light mb-sm-2">Cupiditate Minus</p>
                                <a href="product/details.html" class="font-default">
    ...
    <section class="overflow-hidden product-slider">
        <div>
            <div class="container">
                <div class="row g-3">
                    <div class="col-lg-4">
                        <div class="pb-4 title-3 title-border">
                            <h2>Most Popular</h2>
                            <h5 class="theme-color">Our Collection</h5>
                        </div>
                                        ...
                                        <div class="product-image">
                                            ...
                                            <div class="product-details">
                                                <a href="product/details.html">
                                                    ...
                                                    <h4 class="mt-1 font-light"><del>$49.00</del> <span
    ...
    <section class="pb-5 overflow-hidden ratio_asos">
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-style-3 product-style-chair">
                                <div class="mb-0 product-title d-block">
                                    ...
                                    <p class="mb-0 font-light mb-sm-2">Multicolor Dress</p>
                                    <a href="product/details.html" class="font-default">
