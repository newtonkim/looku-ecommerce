...
@yield('content')
    ...
    <footer class="mt-5 footer-sm-space">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 d-none d-sm-block">
                        <div class="footer-newsletter">
                            ...
                            <div class="form-newsletter">
                                ...
                                <p class="mb-0 font-dark">Keep up to date with our latest news and special offers.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-title">
                        ...
                        <div class="text-center cancel-button">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="modal-product">
                                ...
                                <div class="modal-contain-details">
                                    ...
                                    <p class="my-2 font-light">Yellow, Qty : 3</p>
                                    <div class="product-total">
                                        <h5>TOTAL : <span>$1,140.00</span></h5>
                                    </div>
                                    <div class="mt-3 shop-cart-button">
                                        <a href="shop-left-sidebar.php"
                                            class="rounded btn default-light-theme conti-button default-theme default-theme-2">CONTINUE
                                            SHOPPING</a>
                                        <a href="cart.php"
                                            class="rounded btn default-light-theme conti-button default-theme default-theme-2">VIEW
                                            CART</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-4 ratio_asos">
                        <div class="container">
                            <div class="m-0 row">
                                <div class="p-0 col-sm-12">
                                    <div
                                        class="p-0 product-wrapper product-style-2 slide-4 light-arrow bottom-space spacing-slider">
                                        <div>
                                            <div class="product-box">
                                                ...
                                                <div class="text-center product-details">
                                                    <div class="text-center rating-details d-block">
                                                        <span class="font-light grid-content">B&Y Jacket</span>
                                                    </div>
                                                    <div class="mt-0 text-center main-price d-block">
